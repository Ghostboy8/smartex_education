...
const Hero = () => {
  return (
    <div className='w-full pt-[6vh] md:pt-[10vh] h-screen hero-bg relative overflow-hidden'>
      ...
      <div className='flex justify-center flex-col w-[90%] sm:w-[80%] h-full mx-auto z-10 relative'>
        <div className='grid grid-cols-1 lg:grid-cols-2 items-center gap-12'>
          ...
          <div>
            <h1
              data-aos="fade-up"
              className='text-black text-3xl sm:text-4xl md:text-5xl mt-6 mb-6 font-bold md:leading-[3rem] lg:leading-[3.5rem]'
            >
              Révolutionnez la gestion de votre établissement de formation avec <span className='text-red-700'>SMARTEX Education</span>
            </h1>

            <p className='text-black text-sm md:text-base mb-6' data-aos="fade-up" data-aos-delay="100">
